...
ブレッドボードで組む場合の全体図（ロジック配線 + 電源経路）:

![ブレッドボード配線: 消費電力測定](hardware/docs/breadboard-power.svg)

![ブレッドボード配線: DC-DC 効率測定](hardware/docs/breadboard-efficiency.svg)
...
キャリア基板でのつなぎ方（赤 = ＋側、青 = −側。USB が左、端子台が上辺）:

![消費電力測定のつなぎ方](hardware/docs/wiring-power.svg)
...
![DC-DC 効率測定のつなぎ方](hardware/docs/wiring-efficiency.svg)

ch1 用の INA228 は裏の A0 ジャンパを閉じて右の J3 に挿す。詳細は
[hardware/README.md](hardware/README.md#使い方配線図)。
